      ...
      <div>
        <div id="carouselExampleFade" className="carousel slide carousel-fade" data-bs-ride="carousel" >
          <div className="carousel-inner" id='carousel'>
            ...
            <div className="carousel-item">
              <img src="https://source.unsplash.com/random/300×300/?mirinda" className="d-block w-100" style={{ filter: "brightness(30%)" }} alt="..." />
            </div>
          </div>
                    ...
                    .map(filterItems => {
                      return (
                        <div key={filterItems._id} className='col-12 col-md-6 col-lg-3'>
                          ...
                          <Card
                          // {/* //in video, it takes in one line i.e. foodItem = {filterItems} but here it is not working */}
